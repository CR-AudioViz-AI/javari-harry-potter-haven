// app/page.tsx — Javari Harry Potter Haven
// AI-powered HP collectibles tracker
  ...
  return (
    <div style={{ background: '#07080f', minHeight: '100vh', color: 'white',
      ...
      <nav style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 100,
        ...
        <span style={{ fontWeight: 800, fontSize: 15, color: '#6366f1' }}>Javari Harry Potter Haven</span>
